sap.ui.define([
	...
	return BaseController.extend("vn.pp.ux_vn_pp_config.controller.MMTrans_001", {
		...
		onSearch: function (oEvent) {
			...
			var aFilters = [];
			aFilters.push(that.getTableFiltersMCB(oView, "cbcenter_MMTrans_001", "center", false));
			aFilters.push(that.getTableFiltersCB(oView, "cbFinCode_MMTrans_001", "finServ_finCode", false));
			if (aFilters[0] === false) {
