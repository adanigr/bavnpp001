sap.ui.define([
	...
	return BaseController.extend("vn.pp.ux_vn_pp_config.controller.FundSubTypes_001", {
		...
		onSearch: function (oEvent) {
			...
			aFilters.push(that.getTableFiltersCB(oView, "cbfundTypeID", "fundType_ID", false));
