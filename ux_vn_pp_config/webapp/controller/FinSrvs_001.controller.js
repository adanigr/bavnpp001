sap.ui.define([
	...
	return BaseController.extend("vn.pp.ux_vn_pp_config.controller.FinSrvs_001", {
		...
		onSearch: function (oEvent) {
			...
			var aFilters = [];
			aFilters.push(that.getTableFiltersCB(oView, "cbFinType", "finType_finType", false));
			aFilters.push(that.getTableFiltersCB(oView, "cbFinCode", "finCode", false));
