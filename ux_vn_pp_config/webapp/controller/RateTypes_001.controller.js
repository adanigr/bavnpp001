sap.ui.define([
	...
	return BaseController.extend("vn.pp.ux_vn_pp_config.controller.RateTypes_001", {
		...
		onSearch: function (oEvent) {
			...
			var aFilters = [];
			aFilters.push(that.getTableFiltersCB(oView, "cbId", "rate", false));
