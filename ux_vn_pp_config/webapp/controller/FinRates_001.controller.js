sap.ui.define([
	...
	return BaseController.extend("vn.pp.ux_vn_pp_config.controller.FinRates_001", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf vn.pp.ux_vn_pp_config.view.FinRates_001
		 */
		onInit: function () {
			//Groups ID a Actualizar el primero es el principal
			this.aGroupID = ["FinRates_001", "FinRates_001_new"];
			//Nombre modelo a actualizar
			this.sModelName = "modeloConfig";
			//Nombre de tablas a actualizar
			this.sObjectName = "tableFinRates_001";
		...
		onSearch: function (oEvent) {
			...
			var aFilters = [];
			aFilters.push(that.getTableFiltersCB(oView, "cbFinCode_FinTypes_001", "finType_finType", false));
			aFilters.push(that.getTableFiltersCB(oView, "cbfundType_ID_FinRates_001", "rateType_rate", false));
